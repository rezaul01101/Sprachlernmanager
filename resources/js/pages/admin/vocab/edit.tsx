 ...
 */
function parseCardsInput(text: string): CardForm[] {
                ...
                <Tabs defaultValue="manual">
                    ...
                    <TabsContent value="json" className="space-y-3">
                        ...
                        <p className="text-muted-foreground text-xs">
                            Parsing replaces the cards in the Manual tab —
...
VocabEdit.layout = (props: { level: Level; day: Day }) => ({
    breadcrumbs: [
        ...
        { title: 'Vocab', href: vocab.index(props.level.id) },
        {
            ...
            href: vocab.edit([props.level.id, props.day.id]),
        },
